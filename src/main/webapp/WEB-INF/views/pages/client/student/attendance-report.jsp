  ...
  <main class="flex-grow container p-4 md:p-8 mx-auto">
    ...
    <div class="flex flex-col items-center">
      <c:forEach items="${requestScope.groups}" var="group">
        <a class="block p-2 border-solid border-slate-200 border bg-slate-200 hover:bg-slate-300 rounded-xl" href="/student/attendance-report/detail?student-id=${param["student-id"]}&group-id=${group.id}">${group.name}</a>
      </c:forEach>
    </div>
  </main>
